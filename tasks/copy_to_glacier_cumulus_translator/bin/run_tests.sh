...
## DESCRIPTION
## -----------------------------------------------------------------------------
## Tests the lambda (task) for copy_to_glacier_cumulus_translator using unit tests.
##
##
## USAGE
## -----------------------------------------------------------------------------
## bin/run_tests.sh
##
## This must be called from the (root) lambda directory /tasks/copy_to_glacier_cumulus_translator
## =============================================================================
...
coverage run --source copy_to_glacier_cumulus_translator -m pytest
let return_code=$?
