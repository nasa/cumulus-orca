...
class TestCopyFiles(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ['protected_bucket'] = 'unittest_protected_bucket'
        os.environ['public_bucket'] = 'unittest_public_bucket'
    ...
    def tearDown(self):
        ...
        try:
            ...
            del os.environ['public_bucket']
            del os.environ['protected_bucket']
    ...
    def test_handler_one_file_success(self):
        ...
        print("exp_event: ", self.exp_event)
    ...
    def test_handler_two_records_success(self):
        #TODO I don't know if this is even a valid input...
        boto3.client = Mock()
        s3 = boto3.client('s3')
