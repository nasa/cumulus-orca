...
isort \
    ...
    --force-grid-wrap 0 \
    -m 3 \
    internal_reconcile_report_mismatch.py test
...
bandit -r internal_reconcile_report_mismatch.py test
let return_code=$?
...
coverage run --source internal_reconcile_report_mismatch -m pytest
let return_code=$?
