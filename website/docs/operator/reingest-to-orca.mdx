...
description: Provides documentation for Operators to reingest data back to ORCA.
---
...
obtained from step 5 in the [Submit Granules to be Copied to ORCA](#submit-granules-to-be-copied-to-orca)
