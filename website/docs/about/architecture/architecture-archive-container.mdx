...
**copy_to_glacier** lambda function. This component was designed such that it
...
glacier archive. The metadata written to the catalog is used for data management
