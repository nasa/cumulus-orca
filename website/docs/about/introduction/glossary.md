...
### AWS
See: [aws.amazon.com](https://nasa.github.io/cumulus/docs/aws.amazon.com)
...
### Packages (NPM)
[NPM](https://www.npm.js.com/) hosted node.js packages. Cumulus packages can
...
service APIs, etc). See AWS's Step Function Documentation for more
information. In the context of Cumulus these are the underlying AWS service
...
See [Setting Up a Dev Environment](../../developer/development-guide/code/setup-dev-env) for more information.
## W
### Workflows
