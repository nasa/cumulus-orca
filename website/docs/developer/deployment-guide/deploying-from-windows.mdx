...
- If creating a realistic setup with multiple OUs, apply [Create the ORCA Archive Bucket](creating-orca-glacier-bucket.md) to your PREFIX-orca-primary and PREFIX-orca-reports.
- Run
  ```commandline
