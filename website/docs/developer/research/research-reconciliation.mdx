...
<img src={useBaseUrl('img/Research-Reconciliation-orca-inventory-schema.png')}
...
<img src={useBaseUrl('img/Research-Reconciliation-Cumulus-Reconcile.png')}
zoomInPic={useBaseUrl('img/zoom-in.svg')}
zoomOutPic={useBaseUrl('img/zoom-out.svg')}
resetPic={useBaseUrl('img/zoom-pan-reset.svg')} />
...
- [Creating a Translate Lambda for Cumulus Dashboard Inputs for copy_to_archive](https://bugs.earthdata.nasa.gov/browse/ORCA-175)
...
<img src={useBaseUrl('img/Research-Reconciliation-Catalog-Population.png')}
zoomInPic={useBaseUrl('img/zoom-in.svg')}
zoomOutPic={useBaseUrl('img/zoom-out.svg')}
resetPic={useBaseUrl('img/zoom-pan-reset.svg')} />
...
<img src={useBaseUrl('img/Research-Reconciliation-Internal-Reconcile.png')}
zoomInPic={useBaseUrl('img/zoom-in.svg')}
zoomOutPic={useBaseUrl('img/zoom-out.svg')}
resetPic={useBaseUrl('img/zoom-pan-reset.svg')} />
...
<img src={useBaseUrl('img/Research-Reconciliation-orca-internal-reconciliation-schema.png')}
zoomInPic={useBaseUrl('img/zoom-in.svg')}
zoomOutPic={useBaseUrl('img/zoom-out.svg')}
resetPic={useBaseUrl('img/zoom-pan-reset.svg')} />
