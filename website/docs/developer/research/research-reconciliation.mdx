...
this concept was discussed. The general consensus from the group was that repopulation
of ORCA through a standalone workflow was the best option. In addition, the question
of whether this method was a worthwhile path to pursue was posed on the orca Slack channel
and the users currently using ORCA all agreed they would rather re-ingest into ORCA
as seen by the Slack thread [here](https://eosdis.slack.com/archives/CSXEM5MPX/p1622735484015400).
