...
class StorageAdapterInternalReconciliationPostgres(StorageAdapterInternalReconciliationRDBMS):
    ...
    def __init__(
        ...
        super(StorageAdapterInternalReconciliationPostgres, self).__init__(
            user_connection_uri,
            s3_access_key,
            s3_secret_key)
