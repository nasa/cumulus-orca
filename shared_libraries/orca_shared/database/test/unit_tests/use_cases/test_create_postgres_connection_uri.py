...
class TestCreatePostgresConnectionUri(unittest.TestCase):
    ...
    def test_create_user_uri_happy_path(self, mock_create_connection_uri: MagicMock):
        """
        ...
        mock_create_connection_uri.assert_called_once_with(
            logger=logger,
            host=host,
            port=port,
    ...
    def test_create_admin_uri_happy_path(self, mock_create_connection_uri: MagicMock):
        """
        With no optional properties, return admin database uri.
        """
        admin_database_name = uuid.uuid4().__str__()  # nosec
    ...
    def test_create_admin_uri_overwrite_database(
        self, mock_create_connection_uri: MagicMock
    ):
        """
        ...
        result = create_admin_uri(
            ...
            logger=logger,
            database_name_overwrite=admin_database_name,
        )
        mock_create_connection_uri.assert_called_once_with(
            logger=logger,
            host=host,
