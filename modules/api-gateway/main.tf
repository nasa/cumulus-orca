...
resource "aws_api_gateway_method" "api_graphql_method" {
  rest_api_id   = aws_api_gateway_rest_api.orca_api.id
  resource_id   = aws_api_gateway_resource.api_graphql_resource.id
  http_method   = "POST"
  authorization = "AWS_IAM"
}

# resource "aws_api_gateway_integration" "orca_graphql_integration" {
#   rest_api_id             = aws_api_gateway_rest_api.orca_api.id
#   resource_id             = aws_api_gateway_resource.api_graphql_resource.id
#   http_method             = aws_api_gateway_method.api_graphql_method.http_method
